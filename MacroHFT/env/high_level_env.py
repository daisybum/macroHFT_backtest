...
feature_list_path = os.path.join(ROOT, 'MacroHFT', 'data', 'feature_list')
tech_indicator_list = np.load(os.path.join(feature_list_path, 'single_features.npy'), allow_pickle=True).tolist()
tech_indicator_list_trend = np.load(os.path.join(feature_list_path, 'trend_features.npy'), allow_pickle=True).tolist()
